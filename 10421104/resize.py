...
def parse_opt():
    ...
    parser.add_argument('-i', '--input', type=str, help='.\images\\background.png')
    parser.add_argument('-s', type=str, help='.\images\\background.png')
    parser.add_argument('-o', type=str, help='.\images')
